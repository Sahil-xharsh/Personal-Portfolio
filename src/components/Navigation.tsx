      ...
      <div className="w-full max-w-full flex items-center justify-start sm:justify-center overflow-x-auto no-scrollbar touch-scroll px-3 sm:px-4">
        ...
        >
          ...
          <button
            ...
            className="relative p-1 sm:p-1.5 rounded-full dark:text-[#DCDEDD] text-[#4B4643] dark:hover:text-white hover:text-[#74483F] dark:hover:bg-white/[0.08] hover:bg-[#74483F]/10 transition-all duration-200 cursor-pointer active:scale-90 shrink-0"
          >
            <motion.div
              key={theme}
            ...
            >
              {theme === 'dark' ? (
                <Sun className="w-3.5 h-3.5 sm:w-4 sm:h-4 text-[#e6a99e] hover:text-[#ffffff] transition-colors" />
              ) : (
                <Moon className="w-3.5 h-3.5 sm:w-4 sm:h-4 text-[#74483F] hover:text-[#56332c] transition-colors" />
              )}
            </motion.div>
          </button>
        </nav>
